...
workbook = xlsxwriter.Workbook('Trained_on_8_9_test' + M_test)
...
# LOAD THE TEST DATA
#-----------------------------------------------------------------------------
test_df = pd.read_excel('Test_data_for_8_9.xlsx')
 
# The validation dataset
start_test = 9*1000
end_test = 10*1000
X_test = X[start_test: end_test]
y_test = test_df['mu_9_10'].values
...
for i in range(N_sim):
    ...
    se = 1**2 * RBF(length_scale=ls, length_scale_bounds=(lower_ls, 20))
