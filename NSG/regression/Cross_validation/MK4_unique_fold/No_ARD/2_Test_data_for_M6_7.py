...
Current models:
    ...
    - ANN regression with batch training and online updating
"""
...
se = 1**2 * RBF(length_scale=2.6, length_scale_bounds=(0.01, 2))

wn = WhiteKernel(noise_level=0.4**2,noise_level_bounds=(1e-5, 1))
...
writer = pd.ExcelWriter('Test_data_for_8_9.xlsx')

# Save to spreadsheet
test_data_df.to_excel(writer, sheet_name='mu_9_10', index='DateTime')
writer.save()
