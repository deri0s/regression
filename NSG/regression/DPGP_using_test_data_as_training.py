...
# ls = [64, 64, 64, 7.60, 64, 64, 64, 123, 76, 78]
# ls = [64, 64, 64, 20, 7.60, 20, 64, 123, 76, 78]
# ls = [64, 39, 168, 64, 16, 64, 106, 152, 64, 64]
...
plt.axvline(dt_eval[len(Y_train)], linestyle='--', linewidth=3, color='lime')
