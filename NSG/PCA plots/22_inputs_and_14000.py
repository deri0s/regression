...
print('\nThe tests indices')
for i in range(4):
    print('inicio: ', (i*1000), ' end: ', (i +1)*1000)
    # At each 1000 points
    Xt_test.append(pca.transform(X_test[i*1000: (i +1)*1000]))
    # Comulative 1000 points
    Xt_testc.append(pca.transform(X_test[0: end + (i +1)*1000]))
...
print('\nWhere the training data overlaps the testing data')
for i in range(4):
