...
print('\n Test data indices')
for i in range(4):
    print('inicio: ', (i*1700), ' end: ', (i +1)*1700)
    # At each 1000 points
    Xt_test.append(pca.transform(X_test[i*1700: (i +1)*1700]))
    # Comulative 1000 points
    Xt_testc.append(pca.transform(X_test[0: end + (i +1)*1700]))
...
print('Training data from ', date_time[6500], ' to ', date_time[9500])
print('Testing data from ', date_time_test[1500], ' to ',
      date_time_test[5000])